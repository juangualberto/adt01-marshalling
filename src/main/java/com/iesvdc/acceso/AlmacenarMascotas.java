    ...
    public static void main(String[] args) {
        try (FileOutputStream fileOutput = new FileOutputStream("mascotas.dat");
            ...
            Mascota mascota1 = new Mascota(
                "Whiskers", "ObiJuan", "Gato", LocalDate.of(2020, 5, 10));
            Mascota mascota2 = new Mascota(
                "Rex", "Maria", "Perro", LocalDate.of(2018, 7, 15));
            Mascota mascota3 = new Mascota(
                "Tweety", "Pedro", "Pájaro", LocalDate.of(2019, 2, 28));
            Mascota mascota4 = new Mascota(
                "Yogi", "Mateo", "Oso Pardo", LocalDate.of(2019, 2, 28));
